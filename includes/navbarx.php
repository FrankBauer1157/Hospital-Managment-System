 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
   ...
   <i class="fas fa-american-sign-language-interpreting"></i>
     ...
     <div class="sidebar-brand-text mx-3">MEPP SMS</div>
   </a>
   ...
   <li class="nav-item">
     ...
     <div id="collapseTwo0" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
       <div class="bg-white py-2 collapse-inner rounded">
         ...
         <a class="collapse-item" href="#">SMS Home</a>
         <a class="collapse-item" href="#">Inbox</a>
         <a class="collapse-item" href="#">Qued Messages</a>
         <a class="collapse-item" href="#">Outbox</a>
         <h6 class="collapse-header">Send SMS</h6>
         <a class="collapse-item" href="#">Send Single SMS</a>
         <a class="collapse-item" href="#">Send Bulk Numbers</a>
         <a class="collapse-item" href="#">Import SMS</a>
   ...
   <li class="nav-item">
     ...
     <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
       <div class="bg-white py-2 collapse-inner rounded">
         ...
         <a class="collapse-item" href="#">Create Address Group</a>
         <a class="collapse-item" href="#">View Address Groups</a>
         <a class="collapse-item" href="#">Upload Contacts(Excell)</a>
 ...
 <div id="content-wrapper" class="d-flex flex-column">
  ...
  <strong> Hello <?php  $_SESSION['username'] ?> your 
Credit balance is 858,</strong>to topup through MPESA:[Paybill: [672899]; <strong>A/c rombo.sms]</strong>
